...
res1() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
...
<code>EXP SCRIPT : </code><code>Lifetime</code>
<code>━━━━━━━━━━━━━━━━━━━━</code>
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/versi  )
