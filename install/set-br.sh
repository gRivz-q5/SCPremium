...
rm -rf wondershaper
cd /usr/bin
wget -O backup "https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/menu/backup.sh"
wget -O restore "https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/menu/restore.sh"
wget -O cleaner "https://raw.githubusercontent.com/gRivz-q5/SCPremium/main/install/cleaner.sh"
wget -O xp "https://raw.githubusercontent.com/gRivz-q5/SCPremium/install/xp.sh"
